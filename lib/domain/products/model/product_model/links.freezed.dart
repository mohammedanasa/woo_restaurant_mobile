...
abstract class $LinksCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Self>? self, List<Collection>? collection});
}
...
class _$LinksImpl implements _Links {
  _$LinksImpl({final List<Self>? self, final List<Collection>? collection})
      : _self = self,
...
abstract class _Links implements Links {
  factory _Links({final List<Self>? self, final List<Collection>? collection}) =
      _$LinksImpl;
